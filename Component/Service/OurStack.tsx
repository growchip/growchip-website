...
function OurStack() {
  ...
  return (
    <>
      <section className="max-w-7xl mx-auto py-16 sm:py-20 lg:py-24 overflow-hidden">
  {/* Container */}
  <div className=" px-4 sm:px-6 md:px-8 lg:px-12">
    ...
    <div className="text-center max-w-3xl mx-auto">
      ...
      <p className="mt-4 sm:mt-6 text-gray-300 dark:text-gray-400 text-sm sm:text-base md:text-lg leading-relaxed">
        Great software needs the right foundation. That's why we use a modern tech stack
        that ensures performance, scalability, and security. With expertise in the latest
        tools, frameworks, and platforms, we deliver custom software that is future-ready
        and built to last.
      </p>
    </div>
