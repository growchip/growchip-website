...
function HeroSection() {
  ...
  className="
    ...
    pb-20 sm:pb-24 md:pb-28 lg:pb-36 xl:pb-40
    text-center
  "
>
  <div
    className="
      w-full 
      border-x-2 rounded-4xl
      bg-radial-[at_50%_75%]
      from-[#2596BE]/0 via-[#2596BE]/20 to-black/30 to-90%
      rounded-2xl sm:rounded-[32px] md:rounded-[40px] lg:rounded-[56px] xl:rounded-[70px]
